...
namespace Microsoft.Extensions.DependencyInjection
{
	...
	public static class FusionCacheServiceCollectionExtensions
	{
		...
		public static IServiceCollection AddFusionCache(this IServiceCollection services, Action<FusionCacheOptions>? setupOptionsAction = null, bool useDistributedCacheIfAvailable = true, bool ignoreMemoryDistributedCache = true, Action<IServiceProvider, IFusionCache>? setupCacheAction = null, IMetrics? metrics = null, string cacheName = null)
		{
			if (services is null)
