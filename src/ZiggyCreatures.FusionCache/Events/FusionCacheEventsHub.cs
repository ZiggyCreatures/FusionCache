	...
	: FusionCacheCommonEventsHub
{
	...
	internal void OnFailSafeActivate(string operationId, string key)
	{
		...
		FailSafeActivate?.SafeExecute(operationId, key, _cache, static x => new FusionCacheEntryEventArgs(x), nameof(FailSafeActivate), _logger, _errorsLogLevel, _syncExecution);
	}
	...
	internal void OnFactorySyntheticTimeout(string operationId, string key)
	{
		...
		FactorySyntheticTimeout?.SafeExecute(operationId, key, _cache, static x => new FusionCacheEntryEventArgs(x), nameof(FactorySyntheticTimeout), _logger, _errorsLogLevel, _syncExecution);
	}
	...
	internal void OnFactoryError(string operationId, string key)
	{
		...
		FactoryError?.SafeExecute(operationId, key, _cache, static x => new FusionCacheEntryEventArgs(x), nameof(FactoryError), _logger, _errorsLogLevel, _syncExecution);
	}
	...
	internal void OnFactorySuccess(string operationId, string key)
	{
		...
		FactorySuccess?.SafeExecute(operationId, key, _cache, static x => new FusionCacheEntryEventArgs(x), nameof(FactorySuccess), _logger, _errorsLogLevel, _syncExecution);
	}
	...
	internal void OnBackgroundFactoryError(string operationId, string key)
	{
		...
		BackgroundFactoryError?.SafeExecute(operationId, key, _cache, static x => new FusionCacheEntryEventArgs(x), nameof(BackgroundFactoryError), _logger, _errorsLogLevel, _syncExecution);
	}
	...
	internal void OnBackgroundFactorySuccess(string operationId, string key)
	{
		...
		BackgroundFactorySuccess?.SafeExecute(operationId, key, _cache, x => new FusionCacheEntryEventArgs(key), nameof(BackgroundFactorySuccess), _logger, _errorsLogLevel, _syncExecution);
	}
	...
	internal void OnEagerRefresh(string operationId, string key)
	{
		...
		EagerRefresh?.SafeExecute(operationId, key, _cache, static x => new FusionCacheEntryEventArgs(x), nameof(EagerRefresh), _logger, _errorsLogLevel, _syncExecution);
	}
	...
	internal void OnExpire(string operationId, string key)
	{
		...
		Expire?.SafeExecute(operationId, key, _cache, static x => new FusionCacheEntryEventArgs(x), nameof(Expire), _logger, _errorsLogLevel, _syncExecution);
	}
