...
This package is an implementation for a FusionCache serializer to be used with the optional distributed cache level, based on the JSON serializer by [ServiceStack](https://docs.servicestack.net/json-format).