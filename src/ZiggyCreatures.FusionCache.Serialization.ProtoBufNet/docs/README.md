...
This package is an implementation for a FusionCache serializer to be used with the optional distributed cache level, based on [protobuf-net](https://github.com/protobuf-net/protobuf-net), one of the most used Protobuf serializer on .NET.