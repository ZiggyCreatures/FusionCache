...
This package is an implementation for a FusionCache serializer to be used with the optional distributed cache layer, based on the uber fast new serializer [MemoryPack](https://github.com/Cysharp/MemoryPack).