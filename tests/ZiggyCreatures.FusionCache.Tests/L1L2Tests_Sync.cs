...
, token: TestContext.Current.CancellationToken);
	...
	public void ReThrowsSerializationExceptions(SerializerType serializerType)
	{
		...
		cache.Set<string>("foo", "sloths, sloths everywhere", x => x.SetDistributedCacheDuration(TimeSpan.FromSeconds(10)), token: TestContext.Current.CancellationToken);
	...
	[Theory]
	[ClassData(typeof(SerializerTypesClassData))]
	public void DistributedLockerWorksWithCacheKeyPrefix(SerializerType serializerType)
	{
		var logger = CreateXUnitLogger<FusionCache>();
